    ...
    <div class="member-name">
        ...
        <?php else: ?>
            ...
            <div>
                ...
                <strong>
                    <?= htmlspecialchars($row['payer_name']) ?>
                </strong>
...
<?php endif; ?>
                            ...
                            <td>
                                ...
                                <div class="action-buttons">
                                    ...
                                    <a
                                        href="payment_view_admin.php?id=<?= (int)$row['payment_id'] ?>"
                                    ...
                                    <a
                                        href="payment_edit_admin.php?id=<?= (int)$row['payment_id'] ?>"
...
function confirmDeletePayment() {
    ...
    if (paymentToDelete !== null) {
        window.location.href =
            "payment_delete_admin.php?id=" + paymentToDelete;
    }
}
