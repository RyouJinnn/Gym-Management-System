...
if (
    ...
    header("Location: payments_staff.php");
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    logActivity(
        $con,
        "Payment Update",
        "Payment #" . $payment_id . " for Member #" . $member_id .
        " was updated to " . $payment_status . " by staff.",
...
if ($payment_status === "Declined") {
    ...
    if (($payment['payment_status'] ?? '') === "Approved") {
        ...
        if($cancelMembership->execute()){

    logActivity(
        $con,
        "Membership Cancellation",
        "Active membership for Member #" . $member_id .
        " and Plan #" . $plan_id .
        " was cancelled because the payment was declined.",
        $_SESSION['staff_id'] ?? null,
        "Staff"
    );
...
if ($payment_status === "Approved") {
        ...
        if ($planData) {
            ...
            if ($existingMembership) {
                ...
                if($membershipUpdate->execute()){

    logActivity(
        $con,
        "Membership Activation",
        $plan_name . " membership for Member #" . $member_id .
        " was activated or renewed by staff.",
        $_SESSION['staff_id'] ?? null,
        "Staff"
    );
...
$membershipUpdate->close();
                ...
                if($membershipInsert->execute()){

    logActivity(
        $con,
        "Membership Creation",
        $plan_name . " membership was created for Member #" .
        $member_id . " by staff.",
        $_SESSION['staff_id'] ?? null,
        "Staff"
    );
...
$membershipInsert->close();
    ...
    header(
        "Location: payment_edit_staff.php?id="
        . $payment_id
        . "&updated=1"
    );
...
<head>
    ...
    <title>Edit Payment | Staff Panel</title>
        ...
        <div class="dashboard-content payment-edit-content">
            ...
            <div class="staff-form-header">
                ...
                <div class="page-header-actions">
                    ...
                    <a
                        href="payment_view_staff.php?id=<?= $payment_id ?>"
