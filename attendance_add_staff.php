        ...
        if ($attendance) {
            ...
            if ($insertStmt->execute()) {
                ...
                logActivity(
                    $con,
                    "Walk-in Check-in",
                    $memberName . " was checked in by " . ($_SESSION['staff_name'] ?? "Staff") . ".",
        ...
        if (!$attendance) {
            ...
            if ($updateStmt->execute()) {
                ...
                logActivity(
                    $con,
                    "Walk-in Check-out",
                    $memberName . " was checked out by " . ($_SESSION['staff_name'] ?? "Staff") . ".",
                    $_SESSION['staff_id'] ?? null,
                    "Staff"
                );
...
<div class="wrapper">
    ...
    $walkInName = trim($walkIn['payer_name'] ?? '');

    $initial = strtoupper(
        substr($walkInName, 0, 1)
    );
