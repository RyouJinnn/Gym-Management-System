...
<td>
    ...
    <div class="member-actions">
        ...
        <!-- VIEW -->
        <a
            href="member_view_admin.php?id=<?php echo (int)$member['id']; ?>"
        ...
        <!-- EDIT -->
        <a
            href="member_edit_admin.php?id=<?php echo (int)$member['id']; ?>"
...
<div id="deleteMemberModal" class="delete-member-modal">

    <div class="delete-member-modal-content">

        <div class="delete-member-modal-icon">
            <i class="fa-solid fa-trash"></i>
        </div>
        ...
        <form
            method="POST"
            action="member_delete_admin.php"
        >
            ...
            <div class="delete-member-modal-actions">

                <button
                    type="button"
                    class="delete-member-cancel-btn"
                ...
                <button
                    type="submit"
                    class="delete-member-confirm-btn"
                >
