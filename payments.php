...
if ($paymentMethod === "GCash") {
    ...
    if (
        ...
        die("Please upload your proof of payment.");
    }
    ...
    if ($file['size'] > 5 * 1024 * 1024) {
        die("Proof of payment must not exceed 5MB.");
    }
    ...
    $newFileName =
        "proof_" . time() . "_" . bin2hex(random_bytes(5)) .
...
logActivity(
    $con,
    "Payment Submission",
    $user['full_name'] . " submitted a payment of ₱" .
    number_format($price, 2) . " for the " . $planName .
    " membership plan using " . $paymentMethod . ".",
    $user['id'],
    "Member"
);
...
>
    Please upload your proof of payment before continuing.
</small>
...
document.querySelector("form").addEventListener("submit", function(event){
    ...
    if(selectedMethod === "GCash" && proofInput.files.length === 0){
