...
if($_SERVER['REQUEST_METHOD'] === 'POST'
    && isset($_POST['delete_membership_id'])){

    $delete_id = (int) $_POST['delete_membership_id'];
    ...
    if($delete->execute()){
        ...
        if($delete->affected_rows > 0){
            ...
            logActivity(
                $con,
                "Membership Delete",
                "Membership #".$delete_id." was deleted by admin.",
...
mp.plan_name AS actual_plan_name,
...
$walkInSql .= " ORDER BY p.payment_date DESC ";
...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    $exportSql = "
        SELECT
            ...
            CONCAT('Member #', m.member_id) AS customer_type,
            m.plan_name,
    ...
    $walkInExportResult = $walkInExportStmt->get_result();
    ...
    header(
        'Content-Disposition: attachment; filename="gym_report.csv"'
    );
...
<?php if(isset($_GET['deleted']) && $_GET['deleted'] === '1'): ?>
    ...
    <div class="report-success-message">
        ...
        Membership record was successfully deleted.
    ...
    <?php foreach ($memberships as $membership): ?>
        ...
        <tr>
            ...
            <td>
                ...
                <?php
                echo htmlspecialchars(
    $membership['actual_plan_name'] ?? $membership['plan_name']
);
                ?>
...
<td>
    ...
    method="POST"
    action=""
    onsubmit="return confirmDeleteMembership(this);"
    style="display:inline;"
>

            <input
                type="hidden"
                name="delete_membership_id"
                value="<?php
                    echo (int) $membership['membership_id'];
                ?>"
            >
...
<?php endif; ?>
    ...
    <div class="report-table-header">
        ...
        <div>
            ...
            <p>
                Recorded payments from customers without member accounts.
            </p>
...
function confirmDeleteMembership(form){
...
function closeDeleteMembershipModal(){
...
<div id="deleteMembershipModal" class="delete-modal">
    ...
    <div class="delete-modal-box">
        ...
        <div class="delete-modal-buttons">
            ...
            <button
                type="button"
                class="delete-modal-no"
                onclick="closeDeleteMembershipModal()"
            >
                Cancel
            </button>
